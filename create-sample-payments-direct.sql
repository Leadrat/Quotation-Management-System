-- Create sample payments for dashboard testing
-- This script creates sample payments if the Payments table exists
...
BEGIN
    ...
    -- Insert sample payments with different statuses
