...
{
    /// <inheritdoc />
    public partial class UserRoles_AddAndBackfill : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleName = table.Column<string>(type: "citext", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    TokenJti = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_TokenJti",
                table: "RefreshTokens",
                column: "TokenJti",
                unique: true);
