...
{
    public class GetEmailNotificationLogsQueryValidator : AbstractValidator<GetEmailNotificationLogsQuery>
    {
        public GetEmailNotificationLogsQueryValidator()
        {
            ...
            RuleFor(x => x.RequestorRole)
                ...
                .WithMessage("Only admins can access email notification logs");
