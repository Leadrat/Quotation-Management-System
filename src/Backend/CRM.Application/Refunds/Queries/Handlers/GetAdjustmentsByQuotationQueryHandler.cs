...
{
    public class GetAdjustmentsByQuotationQueryHandler
    {
        private readonly IAppDbContext _db;

        public GetAdjustmentsByQuotationQueryHandler(IAppDbContext db)
        {
            _db = db;
        }

        public async Task<List<AdjustmentDto>> Handle(GetAdjustmentsByQuotationQuery query)
        {
