...
{
    public class UpdateCountryBankFieldConfigurationRequestValidator : AbstractValidator<UpdateCountryBankFieldConfigurationRequest>
    {
        public UpdateCountryBankFieldConfigurationRequestValidator()
        {
