...
{
    public class ConfigureCountryIdentifierRequestValidator : AbstractValidator<ConfigureCountryIdentifierRequest>
    {
        public ConfigureCountryIdentifierRequestValidator()
        {
