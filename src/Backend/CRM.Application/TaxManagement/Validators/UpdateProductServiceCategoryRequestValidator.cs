...
{
    public class UpdateProductServiceCategoryRequestValidator : AbstractValidator<UpdateProductServiceCategoryRequest>
    {
        public UpdateProductServiceCategoryRequestValidator()
        {
