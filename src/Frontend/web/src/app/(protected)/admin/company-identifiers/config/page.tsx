...
export default function IdentifierConfigCountrySelectorPage() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Choose a country to configure identifier types</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {countries.map((country) => (
          <Link
            ...
            href={`/admin/company-identifiers/config/${country.countryId}`}
